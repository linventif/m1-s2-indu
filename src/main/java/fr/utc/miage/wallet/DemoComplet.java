...
/**
 * Fournit une démonstration exécutable complète du fonctionnement principal du
 * projet.
 * <p>
 * Cette classe illustre la création d'actions simples et composées, la gestion
 * de l'historique des prix, l'utilisation directe d'un portefeuille et les
 * opérations d'achat et de vente réalisées par un utilisateur.
 */
@SuppressWarnings({ "java:S106", "java:S1192" })
public final class DemoComplet {
  /** Empêche l'instanciation de cette classe utilitaire. */
  private DemoComplet() {}

  /**
   * Point d'entrée de la démonstration complète.
   *
